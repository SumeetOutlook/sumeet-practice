...
import { ViewFieldPopupComponent } from './view-field-popup/view-field-popup.component';
...
@Component({
  selector: 'app-view-page-creation',
  templateUrl: './view-page-creation.component.html',
  styleUrls: ['./view-page-creation.component.scss']
})
export class ViewPageCreationComponent implements OnInit {
  ...
  listpagedata: any[] = [];
  displayedHeader :any []= []
  displayedColumns = ['Pages', 'AvailableFields'];
  ...
  constructor(public dialog: MatDialog, public localService: LocalStoreService,
    ...
    private jwtAuth:JwtAuthService) 
    {
      ...
      this.displayedHeader = [this.header.Pages, this.header.AvailableFields]
     }
  ...
  openFields(element, data: any = {}) {
    ...
    let dialogRef: MatDialogRef<any> = this.dialog.open(ViewFieldPopupComponent, {
      width: '40vw',
      height: 'auto',
      disableClose: true,
