...
@Component({
  selector: 'app-create-softare-inventory',
  templateUrl: './create-softare-inventory.component.html',
  styleUrls: ['./create-softare-inventory.component.scss']
})
export class CreateSoftareInventoryComponent implements OnInit {
  ...
  openCSIDialog(){
    this.router.navigateByUrl('h11/bb');
