...
@Component({
  selector: 'app-edit-software-license',
  templateUrl: './edit-software-license.component.html',
  styleUrls: ['./edit-software-license.component.scss']
})
export class EditSoftwareLicenseComponent implements OnInit {
  ...
  GetLicenseDetails(){
    var reqData = {
      ...
      searchSoftware : null,  
      searchLicenseType :   null,  
      searchLicenseOption : null, 
      pageSize: 50,
      pageNo: 1
    }
