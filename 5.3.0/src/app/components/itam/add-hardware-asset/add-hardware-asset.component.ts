...
@Component({
  selector: 'app-add-hardware-asset',
  templateUrl: './add-hardware-asset.component.html',
  styleUrls: ['./add-hardware-asset.component.scss']
})
export class AddHardwareAssetComponent implements OnInit {
