...
@Component({
  selector: 'app-asset-transfer-physical-withdraw-dialog',
  templateUrl: './asset-transfer-physical-withdraw-dialog.component.html',
  styleUrls: ['./asset-transfer-physical-withdraw-dialog.component.scss']
})
export class AssetTransferPhysicalWithdrawDialogComponent implements OnInit {
