...
export class UploadDialogComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,public rs: ReconciliationService,
    public dialogRef: MatDialogRef<any>,   
    private fb: FormBuilder,public AllPath : AllPathService,
