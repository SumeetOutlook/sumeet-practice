...
@Component({
  selector: 'app-issue-wise-report',
  templateUrl: './issue-wise-report.component.html',
  styleUrls: ['./issue-wise-report.component.scss']
})
export class IssueWiseReportComponent implements OnInit {
