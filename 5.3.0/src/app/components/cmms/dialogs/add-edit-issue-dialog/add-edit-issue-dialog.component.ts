...
@Component({
  selector: 'app-add-edit-issue-dialog',
  templateUrl: './add-edit-issue-dialog.component.html',
  styleUrls: ['./add-edit-issue-dialog.component.scss']
})
export class AddEditIssueDialogComponent implements OnInit {
  ...
  constructor(public matdialogbox: MatDialogRef<AddEditIssueDialogComponent>,public localService: LocalStoreService, @Inject(MAT_DIALOG_DATA) public data:any,
