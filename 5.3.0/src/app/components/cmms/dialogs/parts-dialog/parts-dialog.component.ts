...
export class PartsDialogComponent implements OnInit {
  ...
  constructor(public matdialogbox: MatDialogRef<PartsDialogComponent>,public localService: LocalStoreService, @Inject(MAT_DIALOG_DATA) public data:any,
  ...
  ngOnInit(){
   ...
   debugger;
    ...
    {     
      ...
      this.dialogSBUForm.controls['partName'].setValue(this.data.rowData['PartName']);
...
onSubmit() {
  let dialogDaaata = {
    ...
    'Part Name': this.dialogSBUForm.controls['partName'].value,
    // 'Qty': this.dialogSBUForm.controls['qty'].value,
    'Cost': this.dialogSBUForm.controls['cost'].value,
    'Photo':''
  };
