...
@Component({
  selector: 'app-non-verify-asset',
  templateUrl: './non-verify-asset.component.html',
  styleUrls: ['./non-verify-asset.component.scss']
})
export class NonVerifyAssetComponent implements OnInit {
  ...
  showAssets(){
    ...
    this.reportService.getNonVerifiableAssets(parameters).subscribe(response => {
      ...
      this.arrBirds = JSON.parse(response);
    })
  }
