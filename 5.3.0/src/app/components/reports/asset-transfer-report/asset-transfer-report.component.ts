...
@Component({
  ...
  styleUrls: ['./asset-transfer-report.component.scss']
})
export class AssetTransferReportComponent implements OnInit {
  ...
  constructor(public AllPathService: AllPathService, public dialog: MatDialog, private httpService: HttpClient, public localService: LocalStoreService, public datepipe: DatePipe,
    ...
    public cls :CompanyLocationService) {
      ...
      this.transferStatus = [
        ...
        // { value:"Transfer Initiated", name:this.header.TransferInitiated},
  ...
  //   this.reportService.GetCompanysForReport(GId,RId).subscribe(response=>{
  //       
  //     response.forEach(element => {
  ...
  SBUGetdata() {
   ...
   // this.userRoleService.GetAllSBU(companyId).subscribe(r => {
    this.cls.GetLocationListByConfiguration(this.SessionGroupId, this.SessionUserId, this.SessionCompanyId, this.SessionRegionId, 62).subscribe(r => {
  ...
  GetTransferIds() {
    ...
    this.reportService.GetTransferIdsForTransferReport(companyIdList, locationIdList, UserId, IsGroupRegion,sbuIdList).subscribe(r => {
      this.transferIdData = [];
      r.forEach(element => {
...
Searchlist :any[];
  ...
  GetInitiatedData() {
    ...
    let url3 = this.groupservice.GetFieldListByPageId(62,this.SessionUserId,this.SessionCompanyId);
    //let url6 = this.groupservice.GetFieldList(62,this.SessionUserId);
  ...
  openPopUp(data: any = {}) {
    ...
    this.ListOfField.forEach((element,index)=>{
      if(element.Custom1 == 'UploadTransferPhoto' || element.Custom1 == 'ATF' || element.Custom1 == 'TransferDocument' ) 
