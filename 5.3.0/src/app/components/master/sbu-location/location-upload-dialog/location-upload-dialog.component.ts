...
@Component({
  selector: 'app-location-upload-dialog',
  templateUrl: './location-upload-dialog.component.html',
  styleUrls: ['./location-upload-dialog.component.scss']
})
export class LocationUploadDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LocationUploadDialogComponent>,
