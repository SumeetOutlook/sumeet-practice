...
@Component({
  selector: 'app-sbu-upload-dialog',
  templateUrl: './sbu-upload-dialog.component.html',
  styleUrls: ['./sbu-upload-dialog.component.scss']
})
export class SbuUploadDialogComponent implements OnInit {

  header:any;
  public SbuInfo: FormGroup;
  fileList: any[];
  fileextlist:any[];
   message: any ;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SbuUploadDialogComponent>,
  ...
  buildSbuForm() {
    this.SbuInfo = this.formBuilder.group({})
  }
