...
@Component({
  selector: 'app-category-upload-dialog',
  templateUrl: './category-upload-dialog.component.html',
  styleUrls: ['./category-upload-dialog.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class CategoryUploadDialogComponent implements OnInit {
  header:any = (headers as any).default;
  public AssetCategory: FormGroup;
  fileList: any[];
  constructor( @Inject(MAT_DIALOG_DATA,) public data: any,
  public uploadService: UploadService,
  public dialogRef: MatDialogRef<CategoryUploadDialogComponent >,
  ...
  buildItemForm() {
    this.AssetCategory = this.fb.group({
    })
  }
