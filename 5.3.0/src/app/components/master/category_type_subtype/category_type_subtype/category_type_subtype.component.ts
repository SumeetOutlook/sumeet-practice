...
export class CategoryTypeSubtypeComponent implements OnInit {
 ...
 displayedHeadersS:any[] = []
  ...
  private isButtonVisibleType = false;
  private isButtonVisibleSubType = false;
  ...
  Serchicon(columnName, isflag) {
    if (columnName == "category") { this.isButtonVisible = !isflag; }
    else if (columnName == "type") { this.isButtonVisibleType = !isflag; }
    else if (columnName == "subtype") { this.isButtonVisibleSubType = !isflag; }
  }
