...
@Component({
  selector: 'app-upload-vendor-popup',
  templateUrl: './upload_vendor_popup.component.html',
  styleUrls: ['./upload_vendor_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadVendorPopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadVendorPopUpComponent>,
