...
@Component({
  selector: 'app-applicationtype-vendor-popup',
  templateUrl: './upload_applicationtype_popup.component.html',
  styleUrls: ['./upload_applicationtype_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadApplicationTypePopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadApplicationTypePopUpComponent>,
  private fb: FormBuilder,public dialog: MatDialog ,public uploadService: UploadService,public allPathService:AllPathService,private loader: AppLoaderService,
