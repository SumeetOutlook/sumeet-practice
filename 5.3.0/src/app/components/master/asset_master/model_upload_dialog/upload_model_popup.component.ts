...
@Component({
  selector: 'app-upload-model-popup',
  templateUrl: './upload_model_popup.component.html',
  styleUrls: ['./upload_model_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadModelPopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadModelPopUpComponent>,
