...
@Component({
  selector: 'app-upload-manufacturer-popup',
  templateUrl: './upload_manufacturer_popup.component.html',
  styleUrls: ['./upload_manufacturer_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadManufacturerPopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadManufacturerPopUpComponent>,
