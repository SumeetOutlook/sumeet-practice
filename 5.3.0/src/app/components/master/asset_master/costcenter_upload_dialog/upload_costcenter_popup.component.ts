...
@Component({
  selector: 'app-costcenter-vendor-popup',
  templateUrl: './upload_costcenter_popup.component.html',
  styleUrls: ['./upload_costcenter_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadCostCenterPopUpComponent implements OnInit
 {
  ...
  public dialogRef: MatDialogRef<UploadCostCenterPopUpComponent>,
