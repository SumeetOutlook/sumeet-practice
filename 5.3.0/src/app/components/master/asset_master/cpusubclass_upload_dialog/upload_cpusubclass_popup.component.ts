...
@Component({
  selector: 'app-upload-cpusubclass-popup',
  templateUrl: './upload_cpusubclass_popup.component.html',
  styleUrls: ['./upload_cpusubclass_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadCPUSubClassPopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadCPUSubClassPopUpComponent>,
  private fb: FormBuilder,
  public dialog: MatDialog,
  public uploadService: UploadService,public allPathService:AllPathService,private loader: AppLoaderService,
