...
@Component({
  selector: 'app-upload-cpuclass-popup',
  templateUrl: './upload_cpuclass_popup.component.html',
  styleUrls: ['./upload_cpuclass_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadCPUClassPopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadCPUClassPopUpComponent>,
