...
@Component({
  selector: 'app-emp-model-popup',
  templateUrl: './emp_model_popup.component.html',
  styleUrls: ['./emp_model_popup.component.scss'],
  animations: [
    trigger('fadeInOut', [
...
export class UploadEmployeePopUpComponent implements OnInit {
  ...
  public dialogRef: MatDialogRef<UploadEmployeePopUpComponent>,
  private fb: FormBuilder,public dialog: MatDialog, public uploadService: UploadService,
  public allPathService:AllPathService,private loader: AppLoaderService,public toastr: ToastrService) { }
     ...
     if(this.fileextlist.indexOf(extension) == -1)
      {
        ...
        this.toastr.error(this.message.fileextensionvalidation3, this.message.AssetrakSays);
        return null;
      }
