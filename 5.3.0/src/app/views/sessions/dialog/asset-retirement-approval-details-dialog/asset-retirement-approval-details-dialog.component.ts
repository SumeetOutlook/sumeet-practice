...
@Component({
  selector: 'app-asset-retirement-approval-details-dialog',
  templateUrl: './asset-retirement-approval-details-dialog.component.html',
  styleUrls: ['./asset-retirement-approval-details-dialog.component.scss']
})
export class AssetRetirementApprovalDetailsDialogComponent implements OnInit {
