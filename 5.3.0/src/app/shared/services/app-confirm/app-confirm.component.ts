...
<div fxLayout="row wrap" fxLayout.lt-sm="column">
      ...
      <button class="btn"  mat-raised-button color="warn" (click)="dialogRef.close(false)"> <mat-icon>close</mat-icon> No</button>
      <button  mat-raised-button class="success" style="margin-left: 5px;" (click)="dialogRef.close(true)"><mat-icon>check</mat-icon> Yes </button> 
      </div>
</div>
</div>`,
})
